...
export default function Products() {
  ...
  return (
    <ProductWrapper>
      <InnerHero backgroundImage={Image} text='Products' />

      <MidSection>
        <Text>
          Techno Glass have working partnerships with all the major flat glass
          manufacturers and therefore can offer products from all raw material
          types including:
        </Text>
        ...
        <UnorderedList>
          ...
          <OrderedList>
            Tinted Glass bronze, dark grey, crystal blue, lake blue, blue, euro
            grey, green
          </OrderedList>
          <OrderedList>
            Reflective glass - bronze, grey, dark grey, blue, euro grey, lake
            blue
          </OrderedList>
          <OrderedList>Mirror 5-12mm</OrderedList>
          <OrderedList>Toughened glass</OrderedList>
          <OrderedList>
            Laminated glass - produced according to customer specs
          </OrderedList>
          <OrderedList>
            Double Glazing - produced according to customer specs
          </OrderedList>
        </UnorderedList>
      </MidSection>
